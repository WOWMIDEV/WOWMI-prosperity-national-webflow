...
/***/ "./src/js/components/Reviews/reviewsSlider.js":
/*!****************************************************!*\
  !*** ./src/js/components/Reviews/reviewsSlider.js ***!
  \****************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "reviewsSliderInit": function() { return /* binding */ reviewsSliderInit; }
/* harmony export */ });
...
swiper__WEBPACK_IMPORTED_MODULE_0__.Swiper.use([swiper__WEBPACK_IMPORTED_MODULE_0__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_0__.Pagination, swiper__WEBPACK_IMPORTED_MODULE_0__.Autoplay]);
var reviewsSliderInit = function reviewsSliderInit() {
  new swiper__WEBPACK_IMPORTED_MODULE_0__.Swiper('.reviews__slider', {
    slidesPerView: 2,
    spaceBetween: 20,
    loop: true,
    speed: 1000,
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 9:
            // eslint-disable-next-line no-console
            console.error("Error: getting reviews from url: ".concat(url));
          ...
          case 13:
            ...
            // eslint-disable-next-line no-console
            console.error("Error: getting reviews: ".concat(_context.t0.message, " from ").concat(url));
            return _context.abrupt("return", false);
...
/***/ "./src/js/components/Yelp/htmlTemplateReview.js":
/*!******************************************************!*\
  !*** ./src/js/components/Yelp/htmlTemplateReview.js ***!
  \******************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var htmlTemplateReview = function htmlTemplateReview(review) {
  var address = review.address,
      rating = review.rating,
      phone = review.phone,
      totalReviews = review.review_count,
      name = review.name,
      imageUrl = review.image_url,
      yelpReviews = review.yelpReviews;
...
/***/ "./src/js/components/Yelp/index.js":
/*!*****************************************!*\
  !*** ./src/js/components/Yelp/index.js ***!
  \*****************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var initReviews = function initReviews() {
  ...
  var city = elements.city,
      sectionYelp = elements.sectionYelp;
  ...
  var base = configRequest.base;
  var cityName = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.getContentElement)(city);
  var url = new URL(base);
  url.searchParams.set('city', cityName);
  (0,_api__WEBPACK_IMPORTED_MODULE_2__.getReviews)(url.href).then(function (reviews) {
    if (!reviews) {
      sectionYelp.remove();
    }

    (0,_render__WEBPACK_IMPORTED_MODULE_1__.renderReviews)(elements, reviews);
  });
  return true;
};
...
/***/ "./src/js/components/Yelp/render.js":
/*!******************************************!*\
  !*** ./src/js/components/Yelp/render.js ***!
  \******************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */   "renderReviews": function() { return /* binding */ renderReviews; }
/* harmony export */ });
/* harmony import */ var _htmlTemplateReview__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./htmlTemplateReview */ "./src/js/components/Yelp/htmlTemplateReview.js");


var htmlReviews = function htmlReviews(reviews) {
  return reviews.map(function (review) {
    return (0,_htmlTemplateReview__WEBPACK_IMPORTED_MODULE_0__.htmlTemplateReview)(review);
  }).join('');
};

var renderReviews = function renderReviews(elements, reviews) {
  var sectionYelp = elements.sectionYelp,
      terms = elements.terms;
  Object.keys(terms).forEach(function (term) {
    var termReviews = reviews.filter(function (review) {
      return review.term === term;
    });
    var wrapperTerm = terms[term];

    if (!wrapperTerm) {
      sectionYelp.remove(); // eslint-disable-next-line no-console

      console.warn("No wrapper for term ".concat(term));
    }
...
/***/ "./src/js/components/adwerx.js":
/*!*************************************!*\
  !*** ./src/js/components/adwerx.js ***!
  \*************************************/
/***/ (function() {

var adwerx = function adwerx() {
  var adwerxEmailEl = document.querySelector('[data-adwerx="email"]');

  if (!adwerxEmailEl) {
    return false;
  }

  var adwerxEmail = adwerxEmailEl.textContent;
  var script = document.createElement('script');
  script.src = "https://pixel.adwerx.com/prosperity/".concat(adwerxEmail, "/awp.js");
...
/***/ "./src/js/components/articlesSlider.js":
/*!*********************************************!*\
  !*** ./src/js/components/articlesSlider.js ***!
  \*********************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var articlesSlider = function articlesSlider(className) {
  swiper__WEBPACK_IMPORTED_MODULE_0__.Swiper.use([swiper__WEBPACK_IMPORTED_MODULE_0__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_0__.Pagination, swiper__WEBPACK_IMPORTED_MODULE_0__.Autoplay]);
  new swiper__WEBPACK_IMPORTED_MODULE_0__.Swiper(className, {
    speed: 600,
    navigation: {
...
var initArticlesSlider = function initArticlesSlider() {
  var ARTICLES_SLIDER_CLASS = '.articles__swiper';
  var elements = {
    articlesSwiperEl: document.querySelector(ARTICLES_SLIDER_CLASS)
  };
  var articlesSwiperEl = elements.articlesSwiperEl;
...
/***/ "./src/js/components/awardsSlider.js":
/*!*******************************************!*\
  !*** ./src/js/components/awardsSlider.js ***!
  \*******************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
new swiper__WEBPACK_IMPORTED_MODULE_0__.Swiper('.awards-slider', {
  slidesPerView: 2,
  spaceBetween: 10,
...
/***/ "./src/js/components/buysideWidget.js":
/*!********************************************!*\
  !*** ./src/js/components/buysideWidget.js ***!
  \********************************************/
/***/ (function() {

var buysideWidget = function buysideWidget() {
  if (window.innerWidth < 768) {
    return false;
  }

  var buysideWidgetWrapper = document.querySelector('[data-buyside="widget"]');
  var buysideWidgetLoadProcess = document.querySelector('[data-buyside="load"]');
  var buysideWidgetKeyEl = document.querySelector('[data-buyside="key"]');
  var buysideWidgetUserNameEl = document.querySelector('[data-buyside="username"]');

  if (!buysideWidgetWrapper || !buysideWidgetUserNameEl || !buysideWidgetKeyEl) {
    return false;
  }

  var buysideWidgetKey = buysideWidgetKeyEl.textContent;
  var buysideWidgetUserName = buysideWidgetUserNameEl.textContent.replace(' ', '');
  var buysideWidgetEl = document.createElement('div');
  var scriptApi = document.createElement('script');
  var arrow = "<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"6\" height=\"11\" viewBox=\"0 0 6 11\" fill=\"none\">\n                  <path d=\"M1 9.5L5 5.5L1 1.5\"\n                  stroke=\"currentColor\"\n                  stroke-width=\"1.5\"\n                  stroke-linecap=\"round\"\n                  stroke-linejoin=\"round\">\n                  </path>\n                </svg>";
  var buysideConfig = {
    widgetContainerId: 'buyside-widget-container',
    // Required - ID of the <div> on your page to place the widget
    key: buysideWidgetKey,
    // Required - the user key you obtained from Buyside
    userName: buysideWidgetUserName,
    // Optional or label identifying an individual user (agent)
    ...
    submitBtnValue: "Get report <span class=\"report__arrow\">".concat(arrow, "</span>"),
    openNewWindow: true
  };

  var addBuysideWidgetInitConfig = function addBuysideWidgetInitConfig() {
    setTimeout(function () {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _plugins_Dropdowns__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../plugins/Dropdowns */ "./src/js/plugins/Dropdowns.js");

var faqDropdowns = new _plugins_Dropdowns__WEBPACK_IMPORTED_MODULE_0__["default"]({
...
/***/ "./src/js/components/membersSlider.js":
/*!********************************************!*\
  !*** ./src/js/components/membersSlider.js ***!
  \********************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var customSizeForMemberSlider = function customSizeForMemberSlider() {
  var onMembersSlideMouseenter = function onMembersSlideMouseenter(event) {
    var slideWidthRatio = 4;
    var target = event.target;
    var memberSliderInner = elements.memberSliderInner;
    var amountOfSlidesToLastVisibleSlide = -1;
    var slideToCheck = target;

    while ((_slideToCheck = slideToCheck) !== null && _slideToCheck !== void 0 && _slideToCheck.classList.contains('swiper-slide-visible')) {
      var _slideToCheck;
    ...
    if (amountOfSlidesToLastVisibleSlide >= 0 && amountOfSlidesToLastVisibleSlide < slideWidthRatio) {
      ...
      var slideInlineMargin = parseInt(getComputedStyle(target).marginRight, 10);
      var slideItemFullWidth = slideWidth + slideInlineMargin;
      var moveToLength = slideItemFullWidth * (slideWidthRatio - 1 - amountOfSlidesToLastVisibleSlide);
      memberSliderInner.style.transform = "translateX(-".concat(moveToLength, "px)");
    }
  };

  var onMembersSlideMouseleave = function onMembersSlideMouseleave() {
    var memberSliderInner = elements.memberSliderInner;
    memberSliderInner.style.transform = 'translateX(0)';
  };

  var initMembersSlided = function initMembersSlided() {
    var slides = elements.slides,
        memberSliderInner = elements.memberSliderInner;
...
var membersSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__.Swiper('.members-slider__inner', {
  spaceBetween: 20,
  slidesPerGroup: 8,
  slidesPerView: 'auto',
...
var addRemoveCloseSlideButton = function addRemoveCloseSlideButton(slide) {
  var action = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'remove';

  if (window.innerWidth > 1024) {
    return false;
  }

  var closeButton = slide.querySelector('.member__close');
...
membersSlider.on('init', function () {
...
/***/ "./src/js/components/overflowBodyForOpenMenu.js":
/*!******************************************************!*\
  !*** ./src/js/components/overflowBodyForOpenMenu.js ***!
  \******************************************************/
/***/ (function() {

var switchOverflowForBody = function switchOverflowForBody(state) {
  document.body.style.overflow = state;
};

var navBarBtnHandler = function navBarBtnHandler(isNavBarBtnAccess, navBarBtn) {
  if (!isNavBarBtnAccess()) {
    return false;
  }

  var isNavOpen = navBarBtn.classList.contains('w--open');
  var stateOverflow = !isNavOpen ? 'hidden' : 'auto';
  switchOverflowForBody(stateOverflow);
  return true;
};

var overflowBodyForOpenMenu = function overflowBodyForOpenMenu() {
  ...
  var isNavBarBtnAccess = function isNavBarBtnAccess() {
    return getComputedStyle(navBarBtn).display === 'block';
  };

  navBarBtn.addEventListener('click', function () {
    return navBarBtnHandler(isNavBarBtnAccess, navBarBtn);
  });
...
/***/ "./src/js/components/quotesSlider.js":
/*!*******************************************!*\
  !*** ./src/js/components/quotesSlider.js ***!
  \*******************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
new swiper__WEBPACK_IMPORTED_MODULE_0__.Swiper('.quotes-slider', {
  slidesPerView: 1,
  spaceBetween: 0,
  speed: 1000,
  effect: 'slide',
...
var scrollUp = function scrollUp() {
  var buttonForScroll = document.querySelector('.btn-up');

  if (!buttonForScroll) {
    return false;
  }

  buttonForScroll.addEventListener('click', function () {
    window.scrollTo({
      top: 0,
      behavior: 'smooth'
    });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": function() { return /* binding */ Dropdowns; }
/* harmony export */ });
...
var Dropdowns = /*#__PURE__*/function () {
  function Dropdowns(_ref) {
    var dropdownSelector = _ref.dropdownSelector,
        toggleSelector = _ref.toggleSelector,
        contentSelector = _ref.contentSelector,
        _ref$activeClass = _ref.activeClass,
        activeClass = _ref$activeClass === void 0 ? 'js--active' : _ref$activeClass,
        _ref$eventType = _ref.eventType,
        eventType = _ref$eventType === void 0 ? 'click' : _ref$eventType,
        _ref$initialDropdowns = _ref.initialDropdowns,
        initialDropdowns = _ref$initialDropdowns === void 0 ? [] : _ref$initialDropdowns,
    ...
    this.isMultiple = isMultiple; // this.closeOnFocusOut = closeOnFocusOut;
  ...
  _createClass(Dropdowns, [{
    ...
    value: function init() {
      ...
      var _loop = function _loop(i) {
        ...
        var dropdown = _this.dropdownsElements[i];
        var toggle = (_dropdown$querySelect = dropdown.querySelector(_this.toggleSelector)) !== null && _dropdown$querySelect !== void 0 ? _dropdown$querySelect : dropdown;
        var content = dropdown.querySelector(_this.contentSelector);
        ...
        if (!content) {
          ...
          toggle.addEventListener(_this.eventType, function () {
            _this.toggle(i);
          });
        }
      };

      for (var i = 0; i < this.dropdownsElements.length; i += 1) {
        _loop(i);
      }

      this.closeMultiple(this.dropdowns.map(function (d) {
        return d.index;
      }).filter(function (d) {
        return !_this.openedDropdowns.has(d);
      })); // setTimeout(() => {
      // });
    ...
    value: function open(i) {
      ...
      var dropdownElement = dropdown.dropdownElement,
          contentElement = dropdown.contentElement,
          contentInnerElement = dropdown.contentInnerElement;
      var heightToSet = contentInnerElement.clientHeight;
      var duration = parseFloat(getComputedStyle(contentElement).transitionDuration) * 1000;

      if (!this.isMultiple) {
        this.openedDropdowns.forEach(function (dropdownIndex) {
          if (i !== dropdownIndex) {
            _this2.close(dropdownIndex);
          }
        });
      }
      ...
      var timeoutId = setTimeout(function () {
        ...
        _this2.deleteTimeout(i);
      }, duration);
      this.timeoutsToResetHeights.set(i, timeoutId);
      contentElement.style.height = "".concat(heightToSet, "px");
    ...
    value: function close(i) {
      ...
      var dropdownElement = dropdown.dropdownElement,
          contentElement = dropdown.contentElement,
          contentInnerElement = dropdown.contentInnerElement;
      var heightToStartWith = contentInnerElement.clientHeight;
      this.deleteTimeout(i);
      contentElement.style.height = "".concat(heightToStartWith, "px");
      setTimeout(function () {
    ...
    key: "openMultiple",
    value: function openMultiple(indexes) {
      var _this3 = this;
    ...
    key: "closeMultiple",
    value: function closeMultiple(indexes) {
      var _this4 = this;
    ...
    key: "deleteTimeout",
    value: function deleteTimeout(i) {
      var timeoutId = Number(this.timeoutsToResetHeights.get(i));
...
/* harmony import */ var remodal_dist_remodal_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! remodal/dist/remodal.css */ "./node_modules/remodal/dist/remodal.css");
/* harmony import */ var remodal_dist_remodal_default_theme_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! remodal/dist/remodal-default-theme.css */ "./node_modules/remodal/dist/remodal-default-theme.css");
...
"use strict";
module.exports = __webpack_require__.p + "svg/phone.svg";
...
/* harmony import */ var _components_adwerx__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/adwerx */ "./src/js/components/adwerx.js");
/* harmony import */ var _components_adwerx__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_components_adwerx__WEBPACK_IMPORTED_MODULE_2__);
...
/* harmony import */ var _components_scrollUp__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/scrollUp */ "./src/js/components/scrollUp.js");
...
/* harmony import */ var _components_membersSlider__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/membersSlider */ "./src/js/components/membersSlider.js");
...
/* harmony import */ var _components_awardsSlider__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/awardsSlider */ "./src/js/components/awardsSlider.js");
/* harmony import */ var _components_quotesSlider__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/quotesSlider */ "./src/js/components/quotesSlider.js");
...
/* harmony import */ var _components_Yelp__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./components/Yelp */ "./src/js/components/Yelp/index.js");
